...
3. **Master index** `index.md` (lowercase — it becomes the Pages site root `index.html`) — all content grouped by `concept.taxonomy`, plus pointers to category indices and the timeline.
