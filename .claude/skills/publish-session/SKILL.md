...
2. **Review changes** — `git status`; group Modified / New / Deleted. In interactive sessions, confirm before proceeding if unexpected files appear. In unattended/scheduled runs, proceed automatically and log unexpected files in the output.
